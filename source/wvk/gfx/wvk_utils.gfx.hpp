...
WVK_API RenderInfo create_render_info(const RenderingInfo &renderingInfo);
...
class PipelineBuilder
{
  public:
	...
	PipelineBuilder &set_shaders(VkShaderModule vertexShader, VkShaderModule geometryShader, VkShaderModule fragmentShader);

	PipelineBuilder &set_shader_stage(VkPipelineShaderStageCreateInfo shaderStage);
