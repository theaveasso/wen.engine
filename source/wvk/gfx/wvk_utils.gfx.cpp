...
PipelineBuilder &PipelineBuilder::set_shaders(
...
PipelineBuilder &PipelineBuilder::set_shader_stage(
	VkPipelineShaderStageCreateInfo shaderStage)
{
	_shader_stages.push_back(shaderStage);
	return *this;
}
...
PipelineBuilder &PipelineBuilder::set_input_topology(
	VkPrimitiveTopology topology)
{
	_input_assembly.topology = topology;
	return *this;
}
PipelineBuilder &PipelineBuilder::set_polygon_mode(
	VkPolygonMode mode)
{
