 ...
 * @param format        The format of the image (e.g., VK_FORMAT_R8G8B8A8_UNORM).
 * @param aspect_flags  Specifies which aspect(s) of the image are included (e.g., VK_IMAGE_ASPECT_COLOR_BIT).
 * @param mip_levels    Number of mipmap levels to include in the view.
 * @return VkImageView  The created image view handle.
 */
[[nodiscard]] VkImageView vk_image_view_init(
    VkDevice           device,
    VkImage            image,
 ...
 */
void vk_image_view_fini(const WenVkContext *ctx, VkImageView image_view);
